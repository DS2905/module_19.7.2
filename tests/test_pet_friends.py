...
# 11 тест (изменение фото питомца ПОВАЛИЛСЯ)
...
# 12 тест (добавление ногово питомца без фото c не коректным auth_key)
...
# 13 тест (добавление ногово питомца без фото c не полными данными (возраст) ПОВЛАИЛСЯ)
